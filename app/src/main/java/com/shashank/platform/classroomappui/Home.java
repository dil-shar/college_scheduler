...
public class Home extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customAdapterForAnnouncements = new CustomAdapterForAnnouncements(dbH.getAllAnnouncements(), getApplicationContext());
        ...
        plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                popupWindow = new PopupWindow(popup, 500, 500, true);
                ...
                select.findViewById(R.id.add_an_announcement).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        popupWindow1.showAtLocation(findViewById(R.id.home), Gravity.CENTER_HORIZONTAL, 0, 0);
